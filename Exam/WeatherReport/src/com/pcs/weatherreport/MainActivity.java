	...
	protected void onCreate(Bundle savedInstanceState) {
	   ...
	   loginBtn.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			intent.putExtra(Constants.USERNAME, getResources().getString(R.id.username_edt));
			intent.putExtra(Constants.PASSWORD, getResources().getString(R.id.password_edt));
		}
	});
